...
<div class="content_wrapper" onmouseover="// alert('content');">
  <div class="page_area" id="page_area">
	<!-- ***contentStart*** -->
      ...
      <h1 class="header" style="text-decoration:underline;">World of Ideas (Infrastructure) Page.<br/>
</h1>
...
<table width="200" border="0" align="center">
  ...
  <tr>
    ...
    <td width="100" align="center"><input type="button" id="submitBtn" name="submitBtn" value="Insert" onclick="worldOfIdeasPage.ajaxInsertItem(document.getElementById('position').value, document.getElementById('title').value, escapeVal(document.getElementById('description')), 2);" /><!--<input type="button" value="Test" onclick="$('#remove-dialog').dialog('open'); //alert(escapeVal(document.getElementById('description')));" />--></td>
  </tr>
  <tr>
