...
<script src="javascript/interactive_banner_admin.js"></script>
...
<body onload="ajaxGetBannerItems();">
...
<div id="main_content">
      ...
      <iframe id="iframe" name="iframe" src="https://e5bf7f99.servage-customer.net/arris_treasures/interactive_banner.php" width="765" height="160" scrolling="no" style="border:none;">
        ...
        <form action="./php_scripts/upload.php" method="post" enctype="multipart/form-data" target="upload_target" onsubmit="startUpload();" >
            <div align="center">
            <p id="f1_upload_process" style="color:#3399FF; position:relative; visibility:hidden" align="center">Inserting...<br/><img src="ajaxphpupload/loader.gif" /></p>
            </div>
